...
combined.to_csv("PCA_homotetramer_scores.csv")
print("\nCombined data saved to 'PCA_homotetramer_scores.csv'.")
...
plt.scatter(pc_scores['PC1_Score'], pc_scores['PC2_Score'], color='tomato', s=80)
